...
# Force libsoup3 x86_64 to 3.6.6 directly from Koji to match i686 in updates, resolving the multilib version mismatch that blocks the main dnf transaction when dealing with the source build of Bazaar (will be removed in the future)
#dnf install -y \
